...
enum mysql_object_attrib_val_table_field {
  MYSQL_OBJECT_ATTRIB_VAL_DB = 0,
  MYSQL_OBJECT_ATTRIB_VAL_TABLE,
  MYSQL_OBJECT_ATTRIB_VAL_ATTRIB_NAME,
  MYSQL_OBJECT_ATTRIB_VAL_ATTRIB_VAL,
...
enum mysql_policy {
  ...
  MYSQL_POLICY_CREATE_TABLE_PRIV,
  MYSQL_POLICY_CREATE_VIEW_PRIV,
  MYSQL_POLICY_DROP_PRIV,
  MYSQL_POLICY_CREATE_PROC_PRIV,
...
bool mysql_grant_user_attribute(THD *thd, LEX_STRING attrib_name, 
      LEX_STRING value, const List<LEX_USER> *user_list);
